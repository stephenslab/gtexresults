...
The beginning of this document compares the analysis without brain.
...
pm.mash.all=read.table("../Data//Aug13withEDposterior.means.txt")[,-1]
...
hist(sign.tissue.func(het.norm(effectsize=pm.mash.beta))/34,main="Proportion of Tissues in which SignDifferentThanMax, EXCLUDING brain",xlab="NumberofTissues",nclass=40,col="blue",freq=FALSE,ylim=c(0,40))

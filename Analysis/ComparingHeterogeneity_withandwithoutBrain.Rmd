...
Let's also count how many associations we might count as inconsistent by simply counting the number of times the signs differed in a vector of posterior means for a given gene snp pair. This changes without brain, as without brain, there were 9597 inconsistent instances.
...
hist((het.func(ebnorm,threshold=0.2)),main="Number of Tissues in which B.norm>alpha*MaxB",xlab="NumberofTissues",nclass=50,col="blue")
#lines(table(het.func(ebnorm,threshold=0.3)),col="green")
#lines(table(het.func(ebnorm,threshold=0.4)),col="blue")
lines(table(het.func(ebnorm,threshold=0.5)),col="red")
#lines(table(het.func(ebnorm,threshold=0.6)),col="purple")
...
hist((het.func(ebnorm,threshold=0.2)),main="Number of Tissues in which B.norm>alpha*MaxBWITHBRAIN",xlab="NumberofTissues",nclass=50,col="blue")
#lines(table(het.func(ebnorm,threshold=0.3)),col="green")
#lines(table(het.func(ebnorm,threshold=0.4)),col="blue")
lines(table(het.func(ebnorm,threshold=0.5)),col="red")
#lines(table(het.func(ebnorm,threshold=0.6)),col="purple")

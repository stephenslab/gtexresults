...
hist(sign.tissue.func(het.norm(effectsize=pm.mash.beta.brain)),main="Number of Tissues in which SignDifferentThanMax,ALL",xlab="NumberofTissues",nclass=50,col="blue",freq=FALSE)
hist(sign.tissue.func(het.norm(effectsize=pm.mash.beta)),main="Number of Tissues in which SignDifferentThanMax, EXCLUDING brain",xlab="NumberofTissues",nclass=40,col="blue",freq=FALSE)
hist(sign.tissue.func(het.norm(effectsize=pm.mash.beta.brain[,c(7:16)])),main="Number of Tissues in which SignDifferentThanMax,brain",xlab="NumberofTissues",nclass=40,col="blue",freq=FALSE)
...
par(mfrow=c(1,3));
hist(hetindex,main="Histogram of Sum of (Normalized Bjr^2),AllTissues",xlab="Homogeneity Index",col="blue",freq=F);
hist(hetindex.nobrain,main="Histogram of Sum of (Normalized Bjr^2),NoBrain",xlab="Homogeneity Index",col="blue",freq=F)
hist(hetindex.brain.only,main="Histogram of Sum of (Normalized Bjr^2),BrainONLY",xlab="Homogeneity Index",col="blue",freq=F)

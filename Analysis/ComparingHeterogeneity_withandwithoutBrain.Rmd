...
require( Hmisc )
Ecdf(x = het.func(het.norm(effectsize=pm.mash.beta),threshold=0.5)/34,main="eCDF of Proportion of Tissues which are greater than 50% of maximum effect",col="blue",lty=2,xlab="Proportion of Tissues greater than 50% max effect")
Ecdf(x = het.func(het.norm(effectsize=pm.mash.beta.brain),threshold=0.5)/44,add = TRUE, col = 'red', lty = 1)
legend("bottomright",legend=c("Brain","NoBrain"),col=c("red","blue"),lty=c(1,2))

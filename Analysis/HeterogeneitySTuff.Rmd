...
# 
# barplot(table(het.func(het.norm(effectsize=pm.mash.beta[nsig>0,]),threshold=0.5)),main="",xlab="NumberofTissues")#,nclass=50,col="grey",freq=FALSE)#,ylim=c(0,0.6))
mtext("All Tissues")
...
heatmap.2(shared.het,density="none",trace="none",dendrogram = "none",col=redblue(256),cexRow=0.5,cexCol=0.5,symm = T,main="Proportion QTLs within 2-fold for a Pair")
#mtext("All Tissues")
...
excludebrainorder=heatmap.2(shared.het,density="none",trace="none",dendrogram = "none",col=redblue(256),main="",cexRow=0.5,cexCol=0.5,symm = T)$rowInd
...
brain.only.order=heatmap.2(shared.het,density="none",trace="none",dendrogram = "none",col=redblue(256),main="",cexRow=0.5,cexCol=0.5,symm = T)$rowInd
```
...
heatmap.2(shared.het[rev(excludebrainorder),(excludebrainorder)],density="none",trace="none",dendrogram = "none",col=redblue(256),main="",cexRow=0.5,cexCol=0.5,symm = T,Rowv = FALSE,Colv = FALSE)
mtext("Excluding Brain")
...
heatmap.2(shared.het[rev(brain.only.order),brain.only.order],density="none",trace="none",dendrogram = "none",col=redblue(256),main="",cexRow=0.5,cexCol=0.5,symm = T,Rowv = FALSE,Colv = FALSE)
mtext("Brain Only")
```

...
hist(nsig[nsig>0],main="Number of Tissues Significant",xlab="NumberofTissues",breaks=0.5:44.5,col="grey",freq=FALSE)#,ylim=c(0,0.6))
...
hist(nsig[nsig>0],main="",xlab="NumberofTissues",breaks=0.5:34.5,col="grey",freq=FALSE)
...
nsig= rowSums(sigmat)
hist(nsig[nsig>0],main="",xlab="NumberofTissues",breaks=0.5:10.5,col="grey",freq=FALSE)
#barplot(table(nsig[nsig>0]),xlab="Number of tissues",main="")
mean(lfsr.brainonly.alltissues[nsig>0,]<0.05)
mtext("Brains Only")
title("Number of Tissues Significant", outer=TRUE)

##Compare with results of the three separate analyses
par(mar=c(4,4.5,2,1))
par(oma=c(3,3,3,3) )
par(mfrow=c(1,3))
...
sigmat=(lfsr<=thresh)
nsig= rowSums(sigmat)
hist(nsig[nsig>0],main="",xlab="NumberofTissues",breaks=0.5:44.5,col="grey",freq=FALSE)
...
hist(nsig[nsig>0],main="",xlab="NumberofTissues",breaks=0.5:10.5,col="grey",freq=FALSE)
mtext("Brain Only")
title("Number of Tissues Significant, Separate", outer=TRUE)
...
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,]),threshold=0.5)),main="Number of Tissues >50% Max Effect",xlab="NumberofTissues",breaks=0.5:44.5,col="grey",freq=FALSE)#,ylim=c(0,0.6))

###Now we plot all three groups together using the three separate analyses

par(mar=c(4,4.5,2,1))
par(oma=c(3,3,3,3) )
par(mfrow=c(1,3))
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,]),threshold=0.5)),main="",xlab="NumberofTissues",col="grey",freq=FALSE,breaks=0.5:44.5)#,ylim=c(0,0.6))
...
sigmat=(lfsr.nobrain<=thresh)
nsig= rowSums(sigmat)
hist((het.func(het.norm(effectsize=pm.mash.nobrain[nsig>0,]),threshold=0.5)),main="",xlab="NumberofTissues",breaks=0.5:34.5,col="grey",freq=FALSE,xlim=c(1,34))#,ylim=c(0,0.6))
...
hist(het.func(brain.norm,threshold=0.5),main="",xlab="NumberofTissues",breaks=0.5:10.5,col="grey",freq=FALSE)#,ylim=c(0,0.6))
mtext("BrainOnly")

title("Number of Tissues >50% Max Effect,Separate", outer=TRUE)
...
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,]),threshold=0.5)),main="",xlab="NumberofTissues",breaks=0.5:44.5,col="grey",freq=FALSE)#,ylim=c(0,0.6))
mtext("All Tissues")
...
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,-c(7:16)]),threshold=0.5)),main="",xlab="NumberofTissues",breaks=0.5:34.5,col="grey",freq=FALSE)#,ylim=c(0,0.6))
mtext("Excluding Brain")
...
title("Number of Tissues >50% Max Effect, using all", outer=TRUE)
```
...
all.tissue.order=heatmap.2(shared.het,density="none",trace="none",dendrogram = "none",col=redblue,cexRow=0.5,cexCol=0.5,symm = T,main="QTLs within 2-fold Shared by Tissues",breaks=seq(0.35,1,by=0.01))$rowInd
...
excludebrainorder=heatmap.2(shared.het,density="none",trace="none",dendrogram = "none",col=redblue,cexRow=0.5,cexCol=0.5,symm = T,main="QTLs within 2-fold Shared by Tissues",breaks=seq(0.35,1,by=0.01))$rowInd
...
brain.only.order=heatmap.2(shared.het,density="none",trace="none",dendrogram = "none",col=redblue,cexRow=0.5,cexCol=0.5,symm = T,main="QTLs within 2-fold Shared by Tissues",breaks=seq(0.35,1,by=0.01))$rowInd
...
heatmap.2(shared.het,density="none",trace="none",dendrogram = "none",col=redblue,cexRow=0.5,cexCol=0.5,symm = T,main="QTLs within 2-fold Shared by Tissues",breaks=seq(0.35,1,by=0.01))
mtext("All Tissues")
...
heatmap.2(shared.het[rev(excludebrainorder),(excludebrainorder)],density="none",trace="none",dendrogram = "none",col=redblue,main="",cexRow=0.5,cexCol=0.5,symm = T,Rowv = FALSE,Colv = FALSE,breaks=seq(0.35,1,by=0.01))
mtext("Excluding Brain")
...
heatmap.2(shared.het[rev(brain.only.order),brain.only.order],density="none",trace="none",dendrogram = "none",col=redblue,main="",cexRow=0.5,cexCol=0.5,symm = T,Rowv = FALSE,Colv = FALSE,breaks=seq(0.35,1,by=0.01))
mtext("Brain Only")
```

Let's also consider how our power changes when we perform the separate analyses and when you do it on a per gene basis:

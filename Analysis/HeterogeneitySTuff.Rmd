...
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,]),threshold=0.5)),main="Number of Tissues >50% Max Effect",xlab="NumberofTissues",breaks=0.5:44.5,col="grey",freq=FALSE,ylim=c(0,0.14))#,ylim=c(0,0.6))
...
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,]),threshold=0.5)),main="",xlab="NumberofTissues",breaks=0.5:44.5,col="grey",freq=FALSE,ylim=c(0,0.14))#,ylim=c(0,0.6))
mtext("All Tissues")
...
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,-c(7:16)]),threshold=0.5)),main="",xlab="NumberofTissues",breaks=0.5:34.5,col="grey",freq=FALSE,ylim=c(0,0.14))#,ylim=c(0,0.6))
mtext("Excluding Brain")
...
hist(het.func(brain.norm,threshold=0.5),main="",xlab="NumberofTissues",breaks=0.5:10.5,col="grey",freq=FALSE,ylim=c(0,0.14))#,ylim=c(0,0.6))
mtext("BrainOnly")

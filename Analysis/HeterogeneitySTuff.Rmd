...
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,]),threshold=0.5)),main="",xlab="NumberofTissues",breaks=0.5:44.5,col="grey",freq=FALSE,ylim=c(0,0.14),xaxt="n")
axis(1, at=seq(1, 44, by=1), labels=c(1:44))#,ylim=c(0,0.6))
mtext("All Tissues")
...
hist((het.func(het.norm(effectsize=pm.mash.beta[nsig>0,-c(7:16)]),threshold=0.5)),main="",xlab="NumberofTissues",breaks=0.5:34.5,col="grey",freq=FALSE,ylim=c(0,0.14),xaxt="n")
...
hist(het.func(brain.norm,threshold=0.5),main="",xlab="NumberofTissues",breaks=0.5:10.5,col="grey",freq=FALSE,xaxt="n",ylim=c(0,0.6))
axis(1, at=seq(1, 10, by=1), labels=c(1:10))#,ylim=c(0,0.6))
mtext("BrainOnly")

title("Number of Tissues >50% Max Effect, Global", outer=TRUE)
```

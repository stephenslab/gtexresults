...
---
First, we simulate data from the GTEx matrices and consider a heatmap of the top 400 (the maxes):
...
library('gplots')
heatmap.2(((as.matrix(max.t))),main="Maxz",dendrogram="none",density="none",Colv=FALSE,#Rowv=FALSE,
...
heatmap.2(((as.matrix(t[1:1000,]))),main="All Data",dendrogram="none",density="none",Colv=FALSE,#Rowv=FALSE,
          trace="none",col=bluered(1000),cexRow=0.5,cexCol=0.5,labRow = "",ylab = "Gene",xlab="",key=TRUE)
```

Estimate Pis and Omegas:
```{r pis}
tspec=NULL

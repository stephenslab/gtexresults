...
```{r covmatsim, echo=FALSE,fig.ext='pdf'}
...
#badt=read.table("~/Desktop/trainz.txt")
ind=sample(seq(1,2000),replace = F)
h=heatmap.2(as.matrix(t[ind,]),main="All",dendrogram="none",density="none",Colv=FALSE,Rowv=FALSE,
            trace="none",
            col=bluered(256),
            #col=rich.colors(1000),
            #col=brewer.pal(1000, "Spectral"),

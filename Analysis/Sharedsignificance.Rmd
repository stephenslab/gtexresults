...
excludebrainorder=heatmap.2(shared.nobrain,##Rowv=FALSE,Colv=FALSE,
          symm=TRUE,dendrogram="none",density="none",trace="none",col=redblue(256),main=paste0("eQTL Shared,excludingBrainSEP"),cexRow=0.5,cexCol=0.5,cex.main=0.5)$rowInd
mtext("Defined as QTL if LFSR<0.05")

brainorder=heatmap.2(shared.brainonly,##Rowv=FALSE,Colv=FALSE,
        symm=TRUE,dendrogram="none",density="none",trace="none",col=redblue(256),main=paste0("eQTL Shared,Brain OnlySEP"),cexRow=0.5,cexCol=0.5,cex.main=0.5)$rowInd
mtext("Defined as QTL if LFSR<0.05")

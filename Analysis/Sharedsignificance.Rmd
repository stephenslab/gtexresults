...
heatmap.2(shared,##Rowv=FALSE,Colv=FALSE,
          symm=TRUE,dendrogram="none",density="none",trace="none",col=redblue,#main=paste0("Proportion of eQTL Shared,AllTissues"),
...
heatmap.2(shared,##Rowv=FALSE,Colv=FALSE,
          symm=TRUE,dendrogram="none",density="none",trace="none",col=redblue,main=paste0("Proportion of eQTL Shared,AllTissues"),cexRow=0.5,cexCol=0.5,cex.main=0.5,breaks=seq(0.35,1,0.01))
mtext("Defined as QTL if LFSR<0.05")

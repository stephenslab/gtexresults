...
heatmap.2((as.matrix(lfsr[rev(y$rowInd),])),main="LFSR,Sorted",dendrogram="none",density="none",Colv=FALSE,#Rowv=FALSE,
...
heatmap.2((as.matrix(lfdr[rev(y$rowInd),])),main="LFDR,Sorted",dendrogram="none",density="none",Colv=FALSE,Rowv=FALSE,
...
heatmap.2((as.matrix(pm.mash.beta)),main="E(Bj|data)",dendrogram="none",density="none",Colv=FALSE,#Rowv=FALSE,
          trace="none",col=bluered(1000),cexRow=0.5,cexCol=0.5,labRow = "",ylab = "Gene",xlab="",key=TRUE)
dev.off()
```
...
![/users/sarahurbut/Dropbox/PaperEdits/Paper/Figures/postmeansheatmap.png](/Users/sarahurbut/Dropbox/PaperEdits/Paper/Figures/postmeansheatmap.png).

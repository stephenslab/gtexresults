...
#y=heatmap.2(as.matrix(lfsr),main="LFSR,Sorted",dendrogram="none",density="none",Colv=FALSE,#Rowv=FALSE,
          trace="none",col=bluered(1000),cexRow=0.5,cexCol=0.5,labRow = "",ylab = "Gene",xlab="",key=FALSE )

y=heatmap.2(as.matrix(lfsr[rev(y$rowInd),]),main="LFSR,Sorted",dendrogram="none",density="none",Colv=FALSE,Rowv=FALSE,
          trace="none",col=bluered(1000),cexRow=0.5,cexCol=0.5,labRow = "",ylab = "Gene",xlab="",key=FALSE)
dev.off()

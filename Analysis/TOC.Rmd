...
We also want to check that tissue specificity in expression is NOT occurring and that the select examples we've chosen don't demonstrate that. 

*  [Tissue Specific Examples](ExprAnalysis.html)

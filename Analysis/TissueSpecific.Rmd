...
tspec_func=function(sigmat,tissuename){
  index_tissue=which(colnames(sigmat)==tissuename)
    sigs=which(rowSums(sigmat)==1 & rowSums(sigmat[,-index_tissue])==0)
  return(rownames(sigmat)[sigs])
  #return(rownames(rownames(sigmat)[sigs])
}
...
wholebloodthree=(which(rownames(maxz)=="ENSG00000181722.11_3_114267837_A_G_b37"))

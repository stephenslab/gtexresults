...
a=barplot(as.numeric(maxb[t,]),las=2,cex.names=0.5,main=paste0("Z Statistics",name),col=col.func.mle(qs$qvalues,b.stat = maxb,j = t),names=colnames(maxb))
...
wholebloodthree=(which(rownames(maxb)=="ENSG000000181722.11_3_114267837_A_G_b37"))

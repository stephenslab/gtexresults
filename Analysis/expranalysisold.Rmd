...
##Check for our select example of tissue specificity in Whole Blood:

These examples were quantitatively specific in WB:
```{r, whole.blood,cache=T}

gene.name="ENSG00000017797.7"
bar_example(gene.name,log(expr.sort))
```



```{r qualspecificwb, cache=T,eval=F}
...
```{r testis,cache=T,eval=F}
Testis qualitative:

# 
# gene.name="ENSG00000059588.5"
# bar_example(gene.name,log(exp.sort))
```

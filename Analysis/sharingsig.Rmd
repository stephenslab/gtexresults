...
```{r effectorderfoldsig,echo=F,fig.height=10,fig.width=10}
library('colorRamps')
library(gplots)
library(ggplot2)
brain.only.order=read.table("../../Dropbox/brain.only.order.txt")[,1]
...
corrplot(shared.fold.size[(all.tissue.order),all.tissue.order],type="upper",cl.lim=c(0,1),tl.col=col[all.tissue.order],tl.cex=0.8,method="color",col=c(blue2green(256),blue2green(256)),main="")

...
heatmap.2((x[h$rowInd,h$rowInd]),Colv=FALSE,Rowv=FALSE,symm=TRUE,dendrogram="none",density="none",trace="none",col=blue2green(256),main=paste0("Cov2CorU",k,"pihat=",round(colSums(pi.mat)[k],2)),cexRow=0.5,cexCol=0.5)
...
```{r heatmapuk3,fig.height=10,fig.width=10}
...
colnames(x)=NULL
rownames(x)=rep(".",44)
corrplot((x[h$rowInd,h$rowInd]),type="upper",cl.lim=c(0,1),tl.col=col[h$rowInd],tl.cex=8,method="color",col=rep(blue2green(256),2))

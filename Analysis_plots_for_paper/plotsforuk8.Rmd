...
Here we plot the correlation matrix and the first 3 eigenvectors of uk8.
...
```{r corplotuk8,fig.height=10,fig.width=10}
library(gplots)
library(ggplot2)
library('colorRamps')
...
```{r heatmapuk8square,fig.height=10,fig.width=10}
...
```{r cormapuk8,fig.height=10,fig.width=10}

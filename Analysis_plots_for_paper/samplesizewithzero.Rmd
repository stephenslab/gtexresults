...
marginal.var=read.table("../../Dropbox/withzero/withzeromarginal.var.txt")[,-1]
...
par(mar=c(5.1,8,4.1,0.1))
barplot(samplesize[sampleorder],cex.names=0.4,las=2,col=as.character(gtex.colors[sampleorder]),horiz = T)
title("Nj",cex.main=0.8)

par(mar=c(5.1,2,4.1,6))
barplot(median.nj.effective[sampleorder],cex.names=0.4,las=2,col=as.character(gtex.colors[sampleorder]),horiz = T,names="",xlim=c(2000,0))

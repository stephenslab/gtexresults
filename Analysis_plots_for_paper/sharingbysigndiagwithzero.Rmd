...
heatmap.2(smat,Rowv=FALSE,Colv=FALSE,
          ...
          cexRow=0.6,cexCol=2,cex.main=0.5,breaks=seq(0.35,1,0.01),labCol=NA)

```

Do as square:

```{r heatmap2signsquare,fig.height=10,fig.width=10}
...
```{r corrplotsign,fig.height=10,fig.width=10}

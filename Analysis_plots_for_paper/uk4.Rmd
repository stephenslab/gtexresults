...
Here we plot the correlation matrix and the first 3 eigenvectors of uk4.
...
```{r corplotuk4,fig.height=10,fig.width=10}
library(gplots)
library(ggplot2)
library('colorRamps')
...
```{r heatmapuk4square,fig.height=10,fig.width=10}
...
```{r cormapuk4,fig.height=10,fig.width=10}

...
##ask at a given lfsr threshold, how many are we incorrectly calling real
sum(beta=0&lfsr.mash<thresh)/sum(lfsr.mash<thresh)
sum(beta=0&lfsr.ash<thresh)/sum(lfsr.ash<thresh)
sum(beta=0&lfsr.bma<thresh)/sum(lfsr.bma<thresh)

##ask what proportion of null associations are called at a given significance threshold

sum(beta==0&lfsr.mash<thresh)/sum(beta==0)
sum(beta==0&lfsr.ash<thresh)/sum(beta==0)
sum(beta==0&lfsr.bma<thresh)/sum(beta==0)
```

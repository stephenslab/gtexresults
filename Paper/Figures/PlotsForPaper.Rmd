...
barplot(colSums(pi.mat),las=2,names=c(colnames(maxz),"all"),main="BMAlitePriorWeight",cex.names = 0.5)

pi.mash=readRDS("../../Data/pisAug13withED.rds")$pihat
pi.mat.mash=matrix(data = pi.mash,nrow = 22,ncol =54,byrow = TRUE)
barplot(colSums(pi.mat.mash),las=2,names=c(paste0("Uk",seq(1:9)),colnames(maxz),"all"),main="MASHPriorWeight",cex.names = 0.5)
```

...
plot(as.matrix(t[1:10000,]),as.matrix(post.means),col=adjustcolor("blue", alpha=0.5), pch=16,main="E(B|Data)/se(bhat) vs Zmle",ylab="E(B|Data)/sebetahat",xlab="Zmle")
...
plot(as.matrix(t[1:10000,]),as.matrix(univariate.ash.pm),col=adjustcolor("blue", alpha=0.5), pch=16,main="E(B|Data_ash)/se(bhat) vs Zmle",ylab="E(B|Data)/sebetahat",xlab="Zmle")

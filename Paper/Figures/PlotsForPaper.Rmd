...
```
Plot sharing at an $LFSR$ of 0.05. We can also compare to the GTEX plots.
...
heatmap.2(shared,Rowv=FALSE,Colv=FALSE,symm=TRUE,dendrogram="none",density="none",trace="none",col=redblue(256),main=paste0("Proportion of eQTL Shared"),cexRow=0.5,cexCol=0.5)

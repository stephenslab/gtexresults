...
I found that the K=1188 set of covariance matrices containing the Identity, the denoised empirical covariance matrix, rank five SFA approximation and rank 3 SVD approximation as well as 5 single-rank SFA factors and the 45 $eqtl.bma.lite$ configurations maximized this likelihood.




\subsection{Training and Testing Procedure: Estimating Hierarchical Weights}
...
\item  Use the EM algorithm to estimate the optimal combination of weights (See Ash et al for details of the EM).
\end{itemize}

...
Here we generate sharing by magnitude. For every pair of tissues, we count the proportion of effects significant in eiterh that are within 2 fold of the magnitude of one another.

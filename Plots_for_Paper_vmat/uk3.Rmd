...
Here we plot the correlation matrix and the first 3 eigenvectors of "Uk3". This
...
knitr::opts_chunk$set(collaprse = TRUE, fig.width = 8,
...
Here, we load the indices and tissue names:
...
Now let's do the eigenplots. *As before, what are these plots showing,
and what sort of interesting results are highlighted by these plots?*

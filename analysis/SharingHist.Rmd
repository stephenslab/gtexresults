...
Here we plot histograms of sharing by magnitude across all tissues
...
Here we plot histograms of sharing by sign across all tissues (left),
tissues other than brain (middle), and brain tissues only (right).

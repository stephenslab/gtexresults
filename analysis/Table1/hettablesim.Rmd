---
title: "heterogeneitytablesimulation"
output: pdf_document
---
...
barplot(as.numeric(rmse.all.table),main="Shared, Structured Effects: Magnitude heterogeneity",
        ylab="relative error (RRMSE)",xlab="Method",col=c("green","blue","red"),names=colnames(rmse.all.table),ylim=c(0,4.0),cex.main=1.5,cex.lab=1,cex.names=1,las=1)

---
title: "Correlation patterns from fifth covariance component"
author: "Sarah Urbut, Gao Wang, Peter Carbonetto and Matthew Stephens"
output: workflowr::wflow_html
---

Here we plot the correlation matrix for the fifth covariance
component, which, similarly to the
[fourth covariance component](Uk4.html), captures some effects
that are stronger in Whole Blood than other tissues.
...
h <- read.table("../data/uk5rowIndices.txt")[,1]
```

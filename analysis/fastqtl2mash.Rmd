...
Windows and Linux) abd cloud computing services such as Amazon Web
...
based on [gaow/lab-base](https://hub.docker.com/r/gaow/lab-base), a
customized Docker image for development with R and Python.

...
1. If you are primarily interested in applying multivariate adaptive
...
2. If you are working with association statistics from the
   [GTEx study][gtex], or a similar data set, please see here for our
   code to convert association statistics in the [FastQTL][fastqtl]
   format, or a similar format, to a format that is more convenient
   for analysis with mashr.

3. If you would like follow the exact steps we took to produce the
   results presented in the manuscript, follow the instructions 
   [here](gtex.html).
...
[Sarah Urbut][sarah],
[Gao Wang](https://github.com/gaow),
...
We provide three sets of code resources to accompany Urbut, Wang,
Carbonetto & Stephens (2017)

This site contains source code to produce results from Urbut,
Wang & Stephens (2017).

If you are primarily interested in applying

##First, note that the z statistics were downloaded from library('mash')
##Then, we compiled a library using SQL lite and the MAXZ represent the maximum z statistic across phenotypes per SNP
##we also ran SFA as follows
###system('sfa -gen maxz -g 16069 -k 5 -n 44 i -o zsfa')

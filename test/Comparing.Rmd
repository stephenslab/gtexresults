...
We can now use ash to compute the same quantitesin a univariate fashion:
...
write.table(univariate.ash.pm,file="univariate.ash.pm.lfsr")
write.table(univariate.ash.lfsr,file="univariate.ash.lfsr")
...
```{r}
post.means=read.table("~/Dropbox/test/Simulationsposterior.means.txt")[,-1]
pmash=univariate.ash.pm
